...
<body>
    ...
    <nav class="nav nav-pills flex-column flex-sm-row">
        ...
        <a class="flex-sm-fill text-sm-center nav-link active" href="/manageNavBar">Nav Bar</a>
    </nav>

    <h1 class="text-center mt-3">Manage Navbar</h1>
    <div class="content">
        <iframe id="iframe" src="/admin/nav" data-locations="1" style="width: 100%; height: 900px; border: none; margin-left:1em; margin-right:1em;"></iframe>

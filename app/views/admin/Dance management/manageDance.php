...
<head>
    ...
    <title>Visit Haarlem - Manage Dance</title>
...
<body>
    ...
    <div class="content">
        <div id="Venues" class="data" style="width:95%">
            <iframe id="iframe" src="/admin/locations" data-locations="4" style="width: 100%; height: 900px; border: none; margin-left:1em; margin-right:1em;"></iframe>
        </div>

        <div id="Artist" class="data" style="width:95%">
            <iframe id="iframe" src="/admin/artists" data-kind="2" style="width: 100%; height: 900px; border: none; margin-left:1em; margin-right:1em;"></iframe>
        </div>

        <div id="Event" class="data" style="width:95%">
            <iframe id="iframe" src="/admin/dance-events" style="width: 100%; height: 900px; border: none; margin-left:1em; margin-right:1em;"></iframe>
        </div>

...
<head>
    ...
    <title>Visit Haarlem - Manage Locations</title>
...
<body>
    ...
    <div class="content">
        <iframe id="iframe" src="/admin/locations" style="width: 100%; height: 900px; border: none; margin-left:1em; margin-right:1em;"></iframe>

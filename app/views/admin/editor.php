        ...
        <div class="row">
            ...
            <div class="col-9 card p-0">
                <div class="card-body">
                    ...
                    <label for="banner-text" class="form-label">Banner</label>
                    <input type="text" id="banner-text" class="form-control mb-2" placeholder="Banner Text">
                    <label for="banner-image" class="form-label">Banner Image</label>
                    <input type="file" name="files[]" id="banner-image" class="form-control mb-2" placeholder="Banner Images" multiple="multiple" accept="image/png, image/gif, image/jpeg">
